...
layout = [['a', 'b'],
          ['c', 'd'],
          ['e', 'f']]
plots = [dict(label='a', cycle=100000, species=1, field='bz', vectors=['jtx', 'jty'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cl.bkr_extra_cmap, vector_cmap=None, vector_label=r'$\mathbf{j}$ [nA/m$^2$]'),
         dict(label='c', cycle=100000, species=1, field='vx', vectors=['vx', 'vy'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cmap, vector_cmap=None, vector_label=r'$\mathbf{v}_{\text{ion}}$', scalar_label=r'$\text{v}_{\text{x, ion}}$'),
         dict(label='e', cycle=100000, species=1, field='pperp1', vectors=['jtx', 'jty'], vector_color='jt', cbar=True, legend=True,
              scalar_cmap=cmap_turbo, vector_cmap=mpl.colormaps['binary'], vector_label=r'$\mathbf{j}$ [nA/m$^2$]', scalar_label=r'$\text{p}_{\perp 1, \text{ion}}$'),
         dict(label='b', cycle=202500, species=1, field='bz', vectors=['jtx', 'jty'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cl.bkr_extra_cmap, vector_cmap=None, vector_label=r'$\mathbf{j}$ [nA/m$^2$]'),
         dict(label='d', cycle=202500, species=1, field='vx', vectors=['vx', 'vy'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cmap, vector_cmap=None, vector_label=r'$\mathbf{v}_{\text{ion}}$', scalar_label=r'$\text{v}_{\text{x, ion}}$'),
         dict(label='f', cycle=202500, species=1, field='pperp1', vectors=['jtx', 'jty'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cmap_turbo, vector_cmap=None, vector_label=r'$\mathbf{j}$ [nA/m$^2$]', scalar_label=r'$\text{p}_{\perp 1, \text{ion}}$'),
         ]
...
stream_seed_points = np.array([[0, 4],
                               [0, 5],
                               [0, 6],
                               [0, 7],
                               [0, 8],
...
vector_plot_opts = dict(
                        density=1.4, # float or (float, float)
                        lw=1.2, # linewidth of streamlines
                        lw_min=0.2,
                        lw_max=2,
...
for p in plots:
    ...
    # --- LABELS 
    # scalar_label = units.pretty_title(p['field'], var_name=True)
    ...
    if vector_field is not None:
        ...
        if p['label'] in ['a', 'b', 'e', 'f']:
            ...
            vector_plot_opts['cbar_alpha'] = 0.7
        else:
