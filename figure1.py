...
# Cut planes are also automatically looked in ".DATA" directory
...
layout = [['a'],
          ...
          ['c']]
plots = [
         dict(label='a', cycle=1, species=1, field='bz', vectors=['jtx', 'jty'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cl.bkr_extra_cmap, vector_cmap=None, vector_label=r'$\mathbf{j}$ [nA/m$^2$]'),
         dict(label='b', cycle=1, species=1, field='vx', vectors=['vx', 'vy'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cmap, vector_cmap=None, vector_label=r'$\mathbf{v}_{\text{ion}}$', scalar_label=r'$\text{v}_{\text{x}, \text{ion}}$'),
         dict(label='c', cycle=1, species=1, field='pperp1', vectors=['jtx', 'jty'], vector_color=None, cbar=True, legend=True,
              scalar_cmap=cmap_turbo, vector_cmap=None, scalar_label=r'$\text{p}_{\perp 1, \text{ion}}$', vector_label=r'$\mathbf{j}$ [nA/m$^2$]'),
         ]
...
for label, ax in axes.items():
    plot.annotate_axes(ax, label, fontsize=20, dark_mode=False)
...
for p in plots:
    ...
    ax.axhline(0, color='white', lw=2, ls='--', alpha=0.6)
    ...
    if vector_field is not None:
        ...
        im_stream = plot.streamlines(ax,
                                     ...
                                     # color=[1,1,1,0.6],
                                     # color=[0,0,0,0.6],
                                     # minlength=0.01, # minimum length of streamline
                                     # maxlength=1.5, # maximum length of streamline
