...
# selection.output_dir = 'output_sel'
...
layout = [['a', 'b', 'c'],
          ['d', 'e', 'f'],
          ['g', 'h', 'i']]
plots = [dict(label='a', cycle=1, species=1, field='rho0', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None, scalar_label=r'$\text{n}_\text{e}$'),
         dict(label='d', cycle=1, species=1, field='de', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=None, vector_label=None),
         dict(label='g', cycle=1, species=1, field='dp', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None),
         dict(label='b', cycle=100000, species=1, field='rho0', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None, scalar_label=r'$\text{n}_\text{e}$'),
         dict(label='e', cycle=100000, species=1, field='de', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=None, vector_label=None),
         dict(label='h', cycle=100000, species=1, field='dp', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None),
         dict(label='c', cycle=202500, species=1, field='rho0', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None, scalar_label=r'$\text{n}_\text{e}$'),
         dict(label='f', cycle=202500, species=1, field='de', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=None, vector_label=None),
         dict(label='i', cycle=202500, species=1, field='dp', vectors=None, vector_color=None, cbar=True, legend=True,
              scalar_cmap=mpl.colormaps['turbo'], vector_cmap=cc.cm.fire, vector_label=None),
         ]
...
for p in plots:
    ...
    if p['label'] in ['a', 'b', 'c']:
        norm_scalar = plot.color_norm(scalar_range, log=True)
    ...
    if vector_field is not None:
        ...
        vector_plot_opts['broken_streamlines'] = False if p['vectors'][0] in ['vx0', 'vy0', 'vz0'] else True
        vector_plot_opts['density'] = 1 if p['vectors'][0] in ['vx0', 'vy0', 'vz0'] else 2
        vector_plot_opts['color'] = 'k' if p['vectors'][0] in ['vx0', 'vy0', 'vz0'] else color
        im_stream = plot.streamlines(ax,
                                     vector_field,
                                     selection, # selection object for bins and limits
                                     # color=color, # array or color
                                     # color=[1,1,1,0.6],
