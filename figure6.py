...
plots = [
         dict(label='a', coord='phys', selection=selection, species=1, field='pperp10', vectors=['jx', 'jy'], vector_color=None, cbar=True, legend=True, scalar_cmap=cmap, vector_cmap=None, vector_label=r'$\mathbf{j}$', scalar_label=r'$\text{p}_{\perp 1, \text{el}}$'),
         dict(label='b', coord='phys-x', selection=selection, x='x', y='pperp10', y_cut=0, labels=r'$p_{\perp 1, \text{el}}$', y_label=r'Pressure [nPa]', color='gray', cmap=cmap),
        ]
...
for p in plots:
    ...
    # if plot_quiver and vector_field is not None:
    #     im_quiver = plot.quivers(axes['b'],
    #                              vector_field,
    #                              selection,
    #                              color_field=vector_color,
    #                              # color='white',
    #                              scale=vector_scale,
    #                              average_cells=10,
    #                              headwidth=5, # head width as multiple of width
    #                              headlength=4,
    #                              alpha=None,
    #                              cmap=cmap_vector,
    #                              norm=norm_vector,
    ...
    #                              legend=True,
    #                              units=vector_units,
    #                              pretty_name=vector_pretty_name,
    #                              )
